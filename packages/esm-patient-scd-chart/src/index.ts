...
const moduleName = '@clinicemr/esm-patient-scd-chart';
...
export const scdPatientDashboard = getAsyncLifecycle(
  () => import('./scd-patient/scd-patient-dashboard.component'),
  options,
);

export const scdGeneralInfoForm = getAsyncLifecycle(
  () => import('./scd-patient/scd-general-info-form.component'),
  options,
);

export const scdGeneralInfoLink = getAsyncLifecycle(
  () => import('./scd-patient/scd-general-info-link.component'),
  options,
);

export const scdDashboardLink = getAsyncLifecycle(
  // t('SCD General Info', 'SCD General Info')
  () => import('./scd-patient/scd-dashboard-link.component'),
  options,
);
